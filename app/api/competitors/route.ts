...
import { syncCompetitorAds } from "@/lib/brand-data";
...
export async function POST(request: NextRequest) {
  ...
  if (!error) {
    // Initiate background sync for ads discovery immediately
    syncCompetitorAds(parsed.data.advertiserId).catch(console.error);
  }

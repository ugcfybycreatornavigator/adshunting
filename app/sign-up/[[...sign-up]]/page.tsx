...
const authAppearance = {
  elements: {
    ...
    footerActionLink: "ml-1.5 text-[13px] font-semibold text-[#111217] hover:text-[#FF3347] transition-colors",
    formFieldErrorText: "mt-1.5 text-[12px] font-medium text-[#FF3347]",
    identityPreviewText: "text-[13px] font-medium text-[#18181B]",
    identityPreviewEditButton: "ml-2 text-[13px] font-semibold text-[#111217] hover:text-[#FF3347] transition-colors",

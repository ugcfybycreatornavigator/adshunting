  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-muted">How AdsHunting derives scores from observable ad data.</p>
      </div>
      ...
      <div className="space-y-6">
        <Card className="p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-muted">
            AdsHunting intelligence is derived strictly from public, observable data points such as:
          </p>
        ...
        <div className="mt-8 rounded-lg bg-surface p-5 text-sm leading-6 text-muted">
          <span className="font-semibold text-ink">Data Limitations:</span> AdsHunting does not infer or claim private performance metrics. We cannot report on actual CTR, ROAS, conversion rates, spend, or revenue data of any advertiser.
        </div>
      </div>
    </div>
  );

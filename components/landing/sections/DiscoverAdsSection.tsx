...
export function DiscoverAdsSection() {
  return (
    <section id="discover" className="py-24 md:py-32 bg-white relative overflow-hidden">
      <LandingContainer className="text-center flex flex-col items-center">
        ...
        <div className="w-full max-w-[1100px] bg-surface-subtle border border-border shadow-[0_20px_60px_rgba(0,0,0,0.06)] rounded-2xl overflow-hidden mb-12 p-4 md:p-8">
          <div className="w-full h-[450px] md:h-[600px] bg-[#FCFDFB] border border-border shadow-sm rounded-xl overflow-hidden flex flex-col relative">
            <div className="h-14 border-b border-border bg-white flex items-center px-4 justify-between">
              ...
              <div className="mx-auto bg-surface-subtle border border-border rounded-lg px-24 py-1.5 text-[13px] font-medium text-text-primary flex items-center gap-2 shadow-sm">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#FCFDFB] to-transparent pointer-events-none"></div>
          </div>
        </div>
